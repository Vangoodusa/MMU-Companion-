...
interface EquipmentDao {
    ...
    @Query("UPDATE equipment SET statusIndicator = :statusIndicator, conditionDescription = :conditionDescription, lastModifiedBy = :modifiedBy, lastModifiedAt = :modifiedAt, updatedAt = :updatedAt WHERE id = :id")
